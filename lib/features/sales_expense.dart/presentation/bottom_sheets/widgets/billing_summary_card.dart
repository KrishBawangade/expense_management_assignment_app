...
class _BillingSummaryCardState extends State<BillingSummaryCard> {
  ...
  void initState() {
    super.initState();
    final controller = Provider.of<AddExpenseController>(context, listen: false);
    _totalController = TextEditingController(
      text: controller.totalAmount?.toStringAsFixed(2) ?? '',
    );
    _paidController = TextEditingController(
      text: controller.paidAmount?.toStringAsFixed(2) ?? '',
    );
                  ...
                  child: Row(
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Icon(Icons.info_outline, size: 20, color: secondaryColor),
                      ),
                    ],
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Icon(Icons.edit, size: 16, color: secondaryColor),
